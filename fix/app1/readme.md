...
You can see the <a href="./org">Generated Code</a>  and <a href="./fixed">Fixed Code</a> for your reference.
...
1. Create this file with the content as like this <a href="./fixed/src/main/java/com/example/application/MyApp.java">this</a>
...
1. Add the depedency entries for `h2` and `thymeleaf` as like this <a href="./fixed/pom.xml">this</a>
...
1. Create this file.
2. Add the entries for `h2`  like this <a href="./fixed/src/main/resources/application.properties">this</a>
...
1. Create this file with the content as like this <a href="./fixed/src/main/java/com/example/application/repository/CustomerRepository.java">this</a>
