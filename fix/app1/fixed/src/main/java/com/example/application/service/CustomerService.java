...
public class CustomerService {
    ...
    public Customer saveCustomer(Customer form) {
...
// Also note that the service methods convert `Customer` objects to `Customer` objects before persisting them to the database, and vice versa when retrieving data. This helps to maintain a clean separation of concerns between the business logic and the data access layer.
